...
export const ROUTE_MANIFEST: RouteManifestItem[] = [
  ...
  { path: '/blog/endustriyel-bakim-teklif-talebi-hazirlama', type: 'page', indexable: true, includeInSitemap: true, includeInLlms: true, prerender: true, updatedAt: '2026-09-24' },
