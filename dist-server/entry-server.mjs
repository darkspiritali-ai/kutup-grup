...
import { Link, MemoryRouter, Navigate, Route, Routes, useLocation, useParams, useSearchParams } from "react-router-dom";
...
//#endregion
//#region src/lib/service-editorial-copy.ts
/**
...
var SERVICE_EDITORIAL_COPY = {
	"dis-cephe-dekoratif-aydinlatma": {
		...
		faqs: [{
			question: "Dış cephe aydınlatması için keşifte hangi bilgiler gerekir?",
			answer: "Yapının konumu, cephe fotoğrafları veya çizimleri, aydınlatılacak yüzeyler, çalışma saatleri, mevcut elektrik altyapısı ve istenen görsel etki ilk değerlendirme için yeterli bir başlangıç sağlar."
		}, {
			question: "Aydınlatma montajında erişim yöntemi nasıl belirlenir?",
			answer: "Cephe geometrisi, zemin koşulları, sabitleme noktaları, çevredeki kullanıcılar ve iş güvenliği gereklilikleri incelenir. Uygun yöntem bu veriler karşılaştırıldıktan sonra belirlenir."
		}]
	},
	"tersane-ve-offshore-hizmetleri": {
		...
		faqs: [{
			question: "Tersane sahasında çalışmaya başlamadan önce ne gerekir?",
			answer: "Çalışma alanı, gemi veya tesis operasyonu, saha izinleri, erişim noktaları, malzeme yöntemi ve acil durum iletişimi birlikte değerlendirilmelidir."
		}, {
			question: "İple erişim her tersane işi için uygun mudur?",
			answer: "Hayır. Yüzey, görev, operasyon trafiği, ekipman ve kurtarma koşulları incelenir; iple erişim, platform veya başka bir yöntem arasından saha için uygun seçenek belirlenir."
		}]
	},
	"ic-ve-dis-cephe-temizlik-hizmetleri": {
		...
		faqs: [{
			question: "Cephe temizliği için fotoğrafla teklif alınabilir mi?",
			answer: "Fotoğraf, yaklaşık alan ve bina bilgisi ilk değerlendirmeyi kolaylaştırır; yöntem ve kesin kapsam için erişim noktalarının ve yüzeyin ayrıca görülmesi gerekebilir."
		}, {
			question: "Her cephede aynı temizlik ürünü kullanılır mı?",
			answer: "Hayır. Yüzey malzemesi, kirin niteliği ve üretici talimatları incelenir. Uygun ürün ve yöntem mümkünse küçük bir deneme alanı üzerinden belirlenir."
		}]
	},
	"guvenlik-agi-kurulumu": {
		...
		faqs: [{
			question: "Güvenlik ağı kurulumu için hangi saha bilgileri gerekir?",
			answer: "Açıklığın ölçüsü, taşıyıcı yüzeyler, düşme veya malzeme riski, kullanım amacı, çalışma süresi ve montaj erişimi temel değerlendirme başlıklarıdır."
		}, {
			question: "Kurulan ağ ne sıklıkla kontrol edilmelidir?",
			answer: "Kontrol aralığı kullanım yoğunluğu, çevre koşulları, ağın yeri ve sistem üreticisinin talimatlarına göre belirlenir. Hasar, gevşeme veya değişiklik görüldüğünde ayrıca kontrol gerekir."
		}]
	},
	"yatay-ve-dusey-yasam-hatti": {
		...
		faqs: [{
			...
			answer: "Yatay hatlar çatı veya bakım yolu boyunca hareket için, düşey hatlar ise merdiven ve benzeri dikey rotalarda bağlantıyı sürdürmek için değerlendirilir. Aynı projede iki sistem birlikte gerekebilir."
		}, {
			question: "Yaşam hattı montajından önce yapı incelemesi gerekir mi?",
			answer: "Evet. Ankraj yüzeyi, taşıyıcı elemanlar, kaplama, kullanım rotası ve kurtarma yaklaşımı görülmeden sistem seçimi kesinleştirilmemelidir."
		}]
	},
	"jeoteknik-uygulamalar": {
		...
		faqs: [{
			question: "Jeoteknik keşif ile uygulama projesi aynı şey midir?",
			answer: "Hayır. Keşif mevcut koşulları ve risk başlıklarını anlamaya yarar. Uygulama projesi için gerekli hesap, çizim, izin ve malzeme kararları ayrıca hazırlanmalıdır."
		}, {
			question: "Kaya veya şev fotoğrafları ilk değerlendirme için yeterli olur mu?",
			answer: "Fotoğraflar ön bilgi sağlar; eğim, su, süreksizlikler, çevre ve erişim koşulları görülmeden kesin çözüm veya maliyet kararı verilmemelidir."
		}]
	},
	"yamac-yuzeyi-temizleme": {
		...
		faqs: [{
			question: "Yamaç temizliği hangi durumlarda yapılır?",
			answer: "Gevşek kaya, taş, bitki veya molozun yol, yapı ya da çalışma alanına etkisi olduğunda; önce saha koşulları incelenerek kontrollü temizlik gerekip gerekmediği belirlenir."
		}, {
			question: "Temizlikten sonra tekrar hareket riski kalır mı?",
			answer: "Kalabilir. Temizlik mevcut malzemeyi azaltır; yüzeyin su, çatlak ve stabilite koşulları ayrıca incelenerek izleme veya kalıcı koruma ihtiyacı belirlenmelidir."
		}]
	},
	"sev-ortuleme": {
		...
		faqs: [{
			question: "Şev örtüleme ile kaya bariyeri arasındaki fark nedir?",
			answer: "Örtüleme yüzeydeki malzeme ve erozyon etkisini kontrol etmeye odaklanır. Bariyer ise hareket eden malzemenin belirli bir hatta tutulması veya yönlendirilmesi için değerlendirilir; aynı sahada ikisi birlikte gerekebilir."
		}, {
			question: "Şev örtüsü montajından önce yüzey temizlenir mi?",
			answer: "Gevşek ve müdahale edilmesi gereken parçalar incelenir. Temizleme kapsamı, yüzeye, risk kaynağına ve seçilecek örtü sistemine göre belirlenir."
		}]
	},
	"hassas-endustriyel-alan-korumasi": {
		...
		faqs: [{
			question: "Hassas tesiste çalışmadan önce hangi belgeler gerekir?",
			answer: "Gereken belgeler tesisin izin düzenine ve görevin niteliğine göre değişir. Çalışma izni, görev tanımı, risk değerlendirmesi, ekipman kayıtları ve acil durum iletişimi baştan belirlenmelidir."
		}, {
			question: "Üretim devam ederken erişim çalışması yapılabilir mi?",
			answer: "Bazı görevler planlanabilir, bazıları için duruş veya izolasyon gerekebilir. Karar tesis operasyonu, ekipman hassasiyeti ve iş güvenliği koşulları birlikte değerlendirildikten sonra verilir."
		}]
	},
	"kaya-bariyeri": {
		...
		faqs: [{
			question: "Kaya bariyeri hangi alanlarda değerlendirilir?",
			answer: "Yol kenarları, yapı çevreleri, enerji ve ulaşım tesisleri veya kaya düşmesi riski görülen çalışma alanları için değerlendirme yapılabilir. Uygunluk arazi incelemesine bağlıdır."
		}, {
			question: "Kaya bariyeri kurulduktan sonra bakım gerekir mi?",
			answer: "Evet. Bariyer hattı, ankrajlar, ağ, halatlar ve çevredeki yamaç değişimleri belirlenen aralıklarla kontrol edilmelidir."
		}]
	},
	"deflektor-tip-ortuleme": {
		...
		faqs: [{
			question: "Deflektör tip örtüleme ile normal şev örtüsü aynı mıdır?",
			answer: "Aynı amaçla kullanılmayabilir. Deflektör hareket yönünü yönetmeye odaklanır; şev örtüsü ise yüzeydeki malzeme ve erozyon etkisini kontrol etmek için değerlendirilir."
		}, {
			question: "Deflektör uygulaması için hangi arazi bilgileri gerekir?",
			answer: "Hareket yönü, yamaç geometrisi, korunacak alan, mevcut su yolları, ankraj zemini ve erişim koşulları temel değerlendirme verileridir."
		}]
	},
	"moloz-bariyer": {
		...
		faqs: [{
			question: "Moloz bariyeri hangi riskler için kullanılır?",
			answer: "Yamaçtan gelen taş, toprak, dal veya benzeri parçaların yol, yapı ve çalışma alanına ulaşmasını azaltmak için değerlendirilir. Sistem seçimi malzemenin niteliğine bağlıdır."
		}, {
			question: "Bariyerin önünde biriken malzeme ne yapılır?",
			answer: "Birikme düzenli olarak gözlenir ve temizlik erişimi önceden planlanır. Birikme kapasiteyi veya su akışını etkiliyorsa saha yeniden değerlendirilmelidir."
		}]
	},
	"ormanda-iple-erisim-hizmetleri": {
		...
		faqs: [{
			question: "Orman arazisinde iple erişim için araç yolu şart mıdır?",
			answer: "Her zaman değil. Yaklaşım yolu, ekipman taşıma ve kurtarma planı saha koşullarına göre incelenir; erişim mümkün değilse görev kapsamı yeniden düzenlenebilir."
		}, {
			question: "Ağaçlara halat bağlanırken nelere dikkat edilir?",
			answer: "Ağacın durumu, bağlantı yüzeyi, yük yönü, çevredeki dallar ve çalışma amacı değerlendirilir. Uygun olmayan bir ağaç bağlantı noktası olarak kullanılmamalıdır."
		}]
	},
	"stand-by-rescue-hizmeti": {
		...
		faqs: [{
			question: "Stand-by rescue hizmeti hangi işlerde düşünülür?",
			answer: "İple erişim, kapalı veya erişimi sınırlı alan, yüksek yapı bakımı ve kurtarma yaklaşımının zor olduğu görevlerde, çalışma başlamadan önce destek kapsamı değerlendirilir."
		}, {
			question: "Kurtarma planı her projede aynı mıdır?",
			answer: "Hayır. Çalışma rotası, ekipman, ankraj, saha erişimi, kişi sayısı ve tesis prosedürü değiştiği için plan görev özelinde hazırlanmalıdır."
		}]
	},
	"ruzgar-enerji-santralleri": {
		...
		faqs: [{
			question: "Rüzgâr türbininde bakım için hangi bilgiler gerekir?",
			answer: "Türbin veya bölüm bilgisi, yapılacak iş, mevcut bakım kaydı, tesis prosedürü, duruş planı, erişim yöntemi ve hava koşulu sınırları ilk değerlendirme için gereklidir."
		}, {
			question: "Hava koşulları türbin erişimini etkiler mi?",
			answer: "Evet. Rüzgâr, yağış, yıldırım, görüş ve yüzey koşulları erişim ve kurtarma kararını etkiler. Çalışma bu koşullar uygun olduğunda planlanmalıdır."
		}]
	},
	"gabion-duvar": {
		...
		faqs: [{
			question: "Gabion duvar için zemin incelemesi gerekir mi?",
			answer: "Evet. Temel zemini, su, arka dolgu, üst kot yükü ve komşu yapılar görülmeden duvarın boyutu veya uygunluğu kesinleştirilmemelidir."
		}, {
			question: "Gabion duvar drenaj sağlar mı?",
			answer: "Taş dolgulu yapı suyun geçişine yardımcı olabilir; ancak drenaj ihtiyacı ve suyun güvenli yönü saha ve proje koşullarına göre ayrıca tasarlanmalıdır."
		}]
	},
	"sahne-isleri-rigging": {
		...
		faqs: [{
			question: "Rigging işi için sahne planı neden önemlidir?",
			answer: "Yükler, asılma noktaları, kablolar, hareket alanı ve sahne altındaki kullanıcılar plan üzerinde görülmeden güvenilir bir kurulum sırası oluşturmak zorlaşır."
		}, {
			question: "Etkinlik sırasında ekipman değiştirilebilir mi?",
			answer: "Değişiklik, yük ve taşıyıcı sistem yeniden değerlendirilmeden yapılmamalıdır. Yeni düzen teknik sorumlu ve etkinlik yetkilisiyle birlikte onaylanmalıdır."
		}]
	},
	"sprat-egitimi": {
		...
		faqs: [{
			question: "SPRAT eğitimi ile SPRAT sertifikası aynı şey midir?",
			answer: "Hayır. Eğitim, katılımcıyı uygulama ve değerlendirmeye hazırlar. Sertifika veya seviye sonucu için güncel kuruluş kuralları ve sınav süreci ayrıca doğrulanmalıdır."
		}, {
			question: "SPRAT eğitimi öncesinde deneyim gerekir mi?",
			answer: "Gereksinim seviyeye ve güncel programa göre değişebilir. Kayıt öncesinde katılımcının deneyimi, hedefi ve resmi ön koşullar birlikte kontrol edilmelidir."
		}]
	},
	"irata-egitimi": {
		...
		faqs: [{
			question: "IRATA eğitimine kayıt olurken hangi bilgi gerekir?",
			answer: "Katılımcının hedef seviyesi, önceki deneyimi, fiziksel hazırlığı, eğitim tarihi tercihi ve resmi ön koşulları ilk görüşmede değerlendirilmelidir."
		}, {
			question: "IRATA eğitimi bitince saha çalışmasına hemen başlanır mı?",
			answer: "Eğitim ve değerlendirme sonucu, işverenin görev tanımı, saha prosedürü ve güncel kuruluş koşulları birlikte incelenmelidir. Tek başına kurs katılımı her görev için yeterli kabul edilmemelidir."
		}]
	},
	"kar-ve-cig-kontrolu": {
		...
		faqs: [{
			question: "Çığ kontrolü için yalnızca bariyer kurmak yeterli midir?",
			answer: "Her sahada aynı çözüm yeterli olmaz. Kar birikimi, yamaç, korunacak alan, su ve operasyon koşulları incelenerek bariyer, izleme veya başka bir yaklaşım değerlendirilmelidir."
		}, {
			question: "Çığ kontrol planı ne zaman güncellenir?",
			answer: "Yeni yağış, rüzgâr, sıcaklık değişimi, yamaç hareketi, tesis kullanımı veya koruma sisteminde değişiklik olduğunda plan yeniden gözden geçirilmelidir."
		}]
	}
};
//#endregion
...
var sanitizeService = (service) => {
	...
	return {
		...publicService,
		metaDescription: sanitizeRichText(publicService.metaDescription, `${publicService.title} için kapsam, yöntem ve saha gereklilikleri hakkında bilgi alın.`),
		intro: sanitizeRichText(publicService.intro, `${publicService.title} kapsamında uygulanacak yöntem, görev ve saha koşullarına göre belirlenir.`),
		...
		advantages: sanitizeList(publicService.advantages, "Proje kapsamına göre yöntem ve ekipman değerlendirmesi"),
		applications: sanitizeList(publicService.applications, "Saha ve görev koşullarına göre uygulama"),
		technicalDetails: sanitizeList(publicService.technicalDetails, "Teknik özellikler üretici dokümanı ve saha gereksinimine göre doğrulanır"),
		whyChooseUs: sanitizeList(publicService.whyChooseUs, "Kapsamı açık ve saha bilgisine dayalı planlama"),
...
//#endregion
//#region src/lib/blog/endustriyel-bakim-teklif-talebi-hazirlama.ts
var bakimTeklifTalebiPost = {
	"slug": "endustriyel-bakim-teklif-talebi-hazirlama",
	"title": "Endüstriyel Bakım İçin Teklif Talebi Nasıl Hazırlanır?",
	"metaDescription": "Endüstriyel bakım teklif talebi için iş tanımı, belge listesi, dosya sürümleri ve açık soruları düzenleyin; farklı kapsamları aynı bilgilerle karşılaştırın.",
	"excerpt": "İlk teklif görüşmesine hazırlanırken mevcut belgeleri, eksik bilgileri ve kapsam sorularını düzenlemek için örnek talep listesi.",
	"category": "İple Erişim Temelleri",
	"publishedAt": "2026-09-24",
	"updatedAt": "2026-09-24",
	"image": {
		"src": "/images/blog/endustriyel-bakim-teklif-talebi-hazirlama.webp",
		"alt": "Teklif hazırlığı için masaya yerleştirilmiş klasörler, belge listesi, cephe, türbin ve gemi görselleri",
		"title": "Endüstriyel bakım teklif talebi için belge hazırlığı",
		"caption": "Belge ve ek listesinin düzenlenmesini anlatan yapay zekâ ile üretilmiş temsili görsel; gerçek bir Kutup Grup ofisini veya projesini göstermemektedir.",
		"width": 1774,
		"height": 887
	},
	"keywords": [
		"endüstriyel bakım teklif talebi",
		"teklif talep dosyası",
		"belge listesi",
		"kapsam karşılaştırması"
	],
	"sections": [
		{
			"heading": "Teklif talebinde önce hangi işin konuşulduğu anlaşılmalı",
			"paragraphs": [
				"Endüstriyel bakım için teklif talebi hazırlarken işin adını, ilgili tesis veya bölümü, beklenen çıktıyı, mevcut belgeleri ve henüz cevaplanmamış soruları aynı dosyada toplayın. Alıcı, ilk sayfayı okuduğunda ne istendiğini ve eklerde ne bulacağını anlayabilsin. Eksik bilgileri tahminle tamamlamak yerine kimin açıklayacağını belirtin. Böylece fiyat istemeden önce herkesin aynı talebi okuyup okumadığını kontrol edebilirsiniz.",
				"“Bakım için fiyat rica ediyoruz” cümlesi, gönderene açık gelse de karşı tarafta farklı işler çağrıştırabilir. Bir taraf yalnızca mevcut kayıtların incelenmesini, diğeri belirli bir bölümde çalışma yapılmasını düşünüyor olabilir. Teklif talep dosyasının görevi bu farkı görünür kılmaktır. Dosyanın dolu olması işin teknik açıdan değerlendirildiği veya başlamaya hazır olduğu anlamına gelmez; burada hazırlanan şey ilk görüşmenin bilgi paketidir.",
				"Bu yazı, satın alma ve işletme arasında belge toplayan kişi için bir hazırlık düzeni önerir. Kurulum yöntemi, ekipman seçimi veya teknik uygunluk kararı içermez. Önerilen listeyi şirketinizin mevcut satın alma düzenine uyarlayabilirsiniz. Zaten kullanılan bir talep numarası ya da belge sistemi varsa ikinci bir düzen kurmak yerine aynı kimlikleri korumak, yazışmaların takibini kolaylaştırır."
			]
		},
		{
			"heading": "Hizmet başlığı ile talep edilen çıktıyı ayırın",
			"paragraphs": [
				"Önce hizmetin hangi başlıkta görüşüleceğini, ardından o görüşmeden ne beklediğinizi yazın. Kutup Grup'un <a href=\"/hizmetler/tersane-ve-offshore-hizmetleri\">tersane ve offshore hizmetleri</a>, <a href=\"/hizmetler/ruzgar-enerji-santralleri\">rüzgar enerji santralleri</a> ve <a href=\"/hizmetler/ic-ve-dis-cephe-temizlik-hizmetleri\">iç ve dış cephe temizliği</a> sayfaları farklı çalışma alanlarını tanıtır. Bu başlıklardan birini seçmek, o alandaki bütün işlerin tek bir teklif içinde bulunduğunu göstermez. Talebinizde ayrıca görüşmek istediğiniz bölümü ve beklediğiniz yanıtı tarif edin.",
				"Örneğin elinizde bir fotoğraf arşivi bulunuyor ve hangi belgelerin ilk değerlendirme için gerekli olduğunu öğrenmek istiyorsanız bunu açıkça söyleyin. Doğrudan uygulama bedeli talep ediyorsanız mevcut iş tanımını ekleyin ve belirsiz satırları ayrı gösterin. “Ön görüşme”, “eksik bilgi bildirimi” ve “tanımlanmış iş için teklif” farklı yanıt beklentileridir. Bunları aynı cümlede üst üste sıralamak alıcıya hangi çıktıyı önce hazırlayacağını anlatmaz.",
				"Erişim kavramlarına yabancı olan bir okuyucu <a href=\"/blog/endustriyel-dagcilik-iple-erisim-rehberi\">iple erişimin temel kavramlarını</a> ayrıca inceleyebilir. Talep dosyasında ise yöntemi varsaymak yerine iş ihtiyacını anlaşılır kılmaya odaklanın. Bir hizmet sayfasının bağlantısı, eklediğiniz belge listesinin veya iş açıklamasının yerine geçmez."
			]
		},
		{
			"heading": "İlk sayfayı bir dosya haritası olarak hazırlayın",
			"paragraphs": [
				"Kapak notu uzun bir şirket tanıtımı olmak zorunda değildir. Talebin kısa adı, ilgili yer, hazırlayan birim, dosyanın tarihi ve yanıt beklenen konu çoğu ilk görüşmenin yönünü gösterir. İletişim için tek bir koordinasyon kişisi belirtin; belirli soruları başka biri cevaplayacaksa görevini ayrıca yazın. Böylece aynı soru farklı birimlere dağıldığında kimin yanıtının dosyaya aktarılacağı anlaşılır.",
				"Eklere numara verin ve her ekin ne olduğunu bir satırla açıklayın. “Ek 02: kuzey cephenin mevcut fotoğraf dizini” gibi bir açıklama, yalnızca “fotoğraflar” demekten daha kullanışlıdır. Bir belge henüz gelmediyse onu varmış gibi listelemeyin. “Bekleniyor” notuyla hangi birimden istendiğini yazabilirsiniz. Dosyada olmayan bir çizime yapılan gönderme, alıcının eksik eki aramak için ayrıca yazışmasına neden olabilir.",
				"Kapak notunun sonunda iki kısa alan bırakın: bu gönderimde cevap beklenen sorular ve sonraki görüşmeye bırakılan konular. Örneğin belge listesinin yeterliliği hakkında yanıt beklenirken ticari koşullar henüz görüşülmeyecek olabilir. Bu ayrım, bilgi isteyen bir e-postanın yanlışlıkla kesin sipariş gibi anlaşılmasını önlemeye yönelik bir iletişim tercihidir; sözleşmenin hukuki niteliği hakkında hüküm vermez."
			]
		},
		{
			"heading": "Aynı yer için aynı adı kullanın",
			"paragraphs": [
				"Bir tesise satın alma listesinde başka, fotoğraf klasöründe başka ad verilmişse alıcının bunları eşleştirmesi gerekir. Talebe kısa bir yer veya varlık listesi ekleyin. Şirketinizde kullanılan bina, gemi, türbin ya da bölüm kimliği varsa onu esas alın. Yeni isim üretiyorsanız bunun yalnızca bu yazışmada kullanılan bir tanım olduğunu belirtin; mevcut resmî kayıtları sessizce yeniden adlandırmayın.",
				"Adres ile çalışma bölümünü ayrı alanlarda tutmak işe yarar. Aynı adres altında farklı binalar bulunabilir; aynı tesis adı birden fazla iş talebinde geçebilir. Yer listesindeki her satırı ilgili ek numarasıyla eşleştirin. Bir fotoğrafın hangi bölüme ait olduğu bilinmiyorsa tahmini bir eşleştirme yapmak yerine bu durumu açıklayın. Görselin dosyada bulunması, konum bilgisinin doğrulandığı anlamına gelmez.",
				"Bu hazırlık için yeni ölçüm veya fotoğraf toplamak üzere çalışma alanına çıkmanız gerekmez. Mevcut, paylaşılmasına izin verilen kayıtlarla başlayın. Arşivde olmayan bilgi, eksik bilgi listesinde kalabilir. Özellikle türbin bağlamına ilişkin ayrı açıklamalar için <a href=\"/blog/ruzgar-turbini-bakiminda-iple-erisim\">rüzgar türbini bakımında iple erişim yazısına</a> geçebilirsiniz; teklif talep dosyasının amacı o teknik değerlendirmenin yerini almak değildir."
			]
		},
		{
			"heading": "Dosya adlarını ek listesinden bağımsız okunabilir kılın",
			"paragraphs": [
				"Bir ek başka klasöre kopyalandığında hangi talebe ait olduğu hâlâ anlaşılmalı. Talep kimliği, kısa belge adı, tarih ve sürüm bilgisini sabit bir sırada kullanabilirsiniz. “son”, “son2” ve “en-son-yeni” gibi adlar yerine anlamı açıklanan sürüm numaraları seçin. Örneğin “talep-A_fotograf-dizini_2026-09-24_v01” bir adlandırma örneğidir; zorunlu bir standart veya gerçek bir proje kaydı değildir.",
				"<a href=\"https://www.archives.gov/records-mgmt/bulletins/2015/2015-01-appendix-b.html\" target=\"_blank\" rel=\"noopener noreferrer\">ABD Ulusal Arşivler ve Kayıtlar İdaresinin dosya adlandırma açıklaması</a>, anlamlı ve tutarlı isimler ile tarih veya sürüm gibi bileşenlerin aynı sırada kullanılmasını önerir. Bu kaynak ABD kamu kayıtları bağlamındadır. Burada yalnızca belge düzeni bakımından yararlanılıyor; Türkiye'deki bir hizmet alımına hukuki ya da teknik şart getirdiği ileri sürülmüyor.",
				"Dosya adındaki tarihin neyi anlattığını ek listesinde belirtin: görüntünün çekildiği gün mü, belgenin hazırlandığı gün mü, yoksa gönderim günü mü? Bilinmeyen çekim tarihinin yerine gönderim tarihini yazıp ikisini eşdeğer göstermeyin. Çok uzun adlara bütün açıklamayı sıkıştırmak yerine ayrıntıları ek listesine taşıyın. Birkaç örnek ad üzerinde uzlaşmak, herkesin farklı kısaltmalar üretmesinden daha okunabilir bir başlangıç sağlar."
			]
		},
		{
			"heading": "Güncel belge ile geçmiş kaydı birlikte yönetmek",
			"paragraphs": [
				"Geçmiş kayıtlar yararlı olabilir, fakat alıcı hangi belgenin mevcut talebe esas alındığını görmelidir. Gönderim listesinde “bu talepte kullanılan sürüm” ve “geçmiş bilgi” ayrımı yapın. Eski bir kayıt yalnızca karşılaştırma amacıyla eklendiyse bunu açıklayın. Eki gönderen kişinin dosyayı yeni kaydetmiş olması, içeriğin yeni incelendiğini veya güncel durumla karşılaştırıldığını göstermez.",
				"<a href=\"https://www.data.cam.ac.uk/organising-storing/file-organisation-naming-version-control\" target=\"_blank\" rel=\"noopener noreferrer\">Cambridge Üniversitesinin dosya düzeni ve sürüm yönetimi açıklaması</a>, etkin dosyalarla eski çalışmaların ayrılmasını ve belge içinde sürüm değişikliklerinin izlenmesini önerir. Araştırma verileri için hazırlanmış bu yaklaşım, teklif yazışmalarındaki belge takibine uyarlanabilir. Bu uyarlama bir mühendislik onayı veya kurumunuzun belge saklama politikasının yerine geçen talimat değildir.",
				"Kısa bir değişiklik notunda önceki sürümü, değişen eki, değişikliğin nedenini ve gönderim tarihini belirtin. “Ek 03 yenilendi; diğer ekler aynı” gibi somut bir cümle, bütün klasörü açıklamasız yeniden göndermekten daha nettir. Eski kopyaları kurumunuzun kayıt düzenine göre koruyun. Alıcının önceki dosyayı silmesini istemek yerine hangi sürümün yeni yanıt için kullanılacağını söyleyin; böylece önceki yazışmanın bağlamı da kaybolmaz."
			]
		},
		{
			"heading": "Eksik bilgiye bir takip sorusu verin",
			"paragraphs": [
				"Boş hücre farklı anlamlara gelebilir: bilgi mevcut değildir, henüz aranmadı veya o talep için gerekli görülmedi. Bu durumları aynı boşlukla göstermeyin. Belgeyi hazırlayan kişi her eksik satırın yanına kısa bir açıklama ve sorunun yöneltileceği birim ekleyebilir. Yanıt tarihi belli değilse tarih uydurmak yerine “tarih henüz verilmedi” demek, sonraki görüşmenin gündemini daha doğru kurar.",
				"Belgenin bulunması ile içeriğinin açıklığa kavuşması da farklıdır. Elinizde bir çizim olabilir fakat hangi sürüm olduğu bilinmeyebilir. Bu durumda “çizim var” satırının yanına “sürüm bilgisi soruldu” yazın. Dosyayı alan kişi belgeyi tekrar istemek yerine sürüm sorusuna yanıt beklediğini görür. Bir belgenin teknik olarak yeterli olup olmadığına belgeyi derleyen kişi kendi başına karar vermemelidir.",
				"Açık soruları tek yerde toplamak, aynı belirsizliğin birkaç e-postada farklı ifadelerle dolaşmasını azaltmaya yardımcı olur. Sorulara kısa kimlikler verin ve gelen cevabı ilgili eke bağlayın. Cevap başka bir dosya gerektiriyorsa o dosyanın gelmesini ayrı bir adım olarak izleyin. “Konu görüşüldü” notu, hangi bilginin geldiğini veya hangi sorunun hâlâ açık olduğunu tek başına anlatmaz."
			]
		},
		{
			"heading": "Sağlayıcılardan aynı başlıklarla yanıt isteyin",
			"paragraphs": [
				"İlk talepte yanıt düzenini de tarif edebilirsiniz. Her iş kalemi için dört durum kullanmak anlaşılır bir başlangıçtır: teklif içinde, teklif dışında, bilgi bekleniyor ve ayrı teklif gerektiriyor. Bunlar editoryal bir karşılaştırma önerisidir; şirketinizin formunda başka adlar varsa aynı anlamı koruyarak uyarlayın. Yanıt verilmeyen bir satırı kendiliğinden “dahil” veya “ücretsiz” saymayın.",
				"Sağlayıcının açıklamasını kendi cümlelerinizle daraltmadan kaydedin. “Ayrı değerlendirilecek” ifadesi yalnızca “hariç” biçiminde aktarılırsa daha sonra görüşülecek bir iş tamamen kapsam dışı sanılabilir. Kısa özetin yanında özgün teklifin dosya adı ve ilgili satırı bulunsun. Böylece karşılaştırmayı okuyan kişi yorumu ve asıl cevabı birbirinden ayırabilir.",
				"İki teklif farklı varsayımlara dayanıyorsa eksik tutarları tahmin ederek tek toplam üretmeye çalışmayın. Önce kapsam farkını açıklayan soruyu iki tarafa da aynı bilgiyle yöneltin. Bu düzen en düşük fiyatı veya en uygun sağlayıcıyı seçmez. Karşılaştırma öncesinde hangi cevapların aynı soruya verildiğini gösterir. Teknik değerlendirme, ticari görüşme ve sipariş kararı şirketinizdeki ilgili sorumluların kendi incelemeleriyle ilerler."
			]
		},
		{
			"heading": "Arşiv eksikse ilk görüşmeyi nasıl tarif edebilirsiniz?",
			"paragraphs": [
				"Varsayımsal olarak yeni görev alan bir tesis koordinatörünün elinde eski fotoğraflar ve kısa bir bakım talebi bulunduğunu düşünelim. Önceki yazışmaların tamamına erişemiyor ve bazı eklerin hangi bölüme ait olduğunu bilmiyor. Bu durumda ilk mesajı “eksiksiz dosya üzerinden kesin teklif” olarak kurmak yerine mevcut belgelerin dökümünü ve açık soruları paylaşabilir. İstenen ilk yanıt, hangi ek bilgilere ihtiyaç duyulduğunun açıklanması olur.",
				"Koordinatör, bilinmeyenleri gizleyerek daha dolu görünen bir paket hazırlamaz. Fotoğrafın çekim tarihi bilinmiyorsa bunu yazar; yalnızca eski kayıt bulunduğunu söyler. Geçmişte yapılmış bir işlemi belge olmadan tamamlanmış iş gibi anlatmaz. Arşivdeki dosya adını koruyup kendi ek numarasını ayrıca vermesi, sonradan asıl kayıt bulunduğunda eşleştirmeyi kolaylaştırabilir.",
				"Bu senaryodaki karar, bir uygulama yöntemini seçmek değildir. İlk görüşmenin amacını değiştirmektir: mevcut belgelerle nelerin konuşulabileceğini ve hangi bilgilerin ayrıca isteneceğini belirlemek. Görüşme sonrasında yeni gelen belge, cevap verdiği soruya bağlanır. Böylece ikinci gönderimde baştan aynı belirsizlikleri anlatmak yerine gerçekten değişen bilgi gösterilebilir."
			]
		},
		{
			"heading": "Birden fazla tesisi tek talepte toplarken",
			"paragraphs": [
				"Bir başka varsayımda satın alma birimi iki ayrı tesis için aynı hizmet başlığı altında bilgi istesin. Bir tesise ait çizimler tam, diğerinin kayıtları kısmi olabilir. Tek bir toplam ek listesi hazırlamak bu farkı saklar. Talep numarası ortak kalabilir; ancak her tesisin kimliği, belge listesi ve açık soruları ayrı görünmelidir. Ortak yazışma ile ayrı kapsamların birbirine karışmaması hedeflenir.",
				"Sağlayıcılardan yanıtı da aynı ayrımla isteyin. Bir tesis için verilen açıklamanın diğerine otomatik olarak uygulanıp uygulanmadığını tahmin etmeyin. Her iki yer için ortak ticari bir yanıt sunulmuşsa hangi kapsamların bu yanıtın içinde bulunduğunu ayrıca sorun. Tesislerden birine ait belgenin sonradan gelmesi halinde hangi bölümün yeniden cevaplanması gerektiği böylece daha rahat takip edilir.",
				"Burada ayrı dosya sayısını artırmak başlı başına bir amaç değildir. Az belge varsa tek bir ek listesinde tesis sütunu yeterli olabilir. Çok sayıda ek varsa alt klasör kullanabilirsiniz. Seçimin ölçüsü, dosyayı ilk kez açan kişinin her ekin hangi yere ait olduğunu anlayabilmesidir. Başka bir tesisin fotoğrafını yalnızca isim benzerliği yüzünden yanlış talebe eklemek, düzenli görünen bir klasörde de mümkün olabilir."
			]
		},
		{
			"heading": "Talep değiştiğinde yalnızca eki yenilemeyin",
			"paragraphs": [
				"Üçüncü durumda görüşmeler sürerken talebe yeni bir bina bölümü eklendiğini varsayalım. Güncellenen fotoğraf klasörünü göndermek, işin genişlediğini tek başına anlatmaz. Kapak notunda eklenen bölümü, değişen talep satırını ve hangi yanıtların yeniden beklendiğini belirtin. Önceki sürüme cevap veren kişi yeni eki yalnızca açıklayıcı fotoğraf sanabilir; kapsam değişikliği ayrıca yazılmalıdır.",
				"Ortak talebe ilişkin soru ve cevapları, o talebe yanıt veren taraflara aynı güncel bilgiyle iletmeyi planlayın. Bir sağlayıcının kendi ticari teklifini veya özel açıklamasını diğerlerine dağıtmak bu önerinin parçası değildir. Paylaşılacak ortak bilgi ile karşı tarafa ait belgeyi ayırın. Kurumunuzun yetki ve paylaşım düzenini izleyin; paket hazırlamak için ilgisiz kişisel veya ticari belgeleri arşive eklemeyin.",
				"Değişiklik günlüğüne gelen cevapların hangi sürüme ait olduğunu da yazın. Yeni kapsamı görmeden verilmiş bir yanıt, eski haliyle saklanabilir ancak güncel karşılaştırmanın cevabıymış gibi işaretlenmez. Sağlayıcıdan yalnızca değişen satırlara yanıt mı, yoksa tüm teklifin yenilenmesini mi beklediğinizi açıkça söyleyin. Bu tercih, yazışmayı yürüten birimin takip edeceği belge setini belirler."
			]
		},
		{
			"heading": "İlk gönderimde kullanılabilecek talep listesi",
			"paragraphs": ["Aşağıdaki listeyi kendi e-posta metninize veya mevcut formunuza uyarlayabilirsiniz. Liste bir şartname, sözleşme veya teknik kontrol formu değildir; ilk bilgi paketinin ne içerdiğini anlatmak için hazırlanmıştır. Alanların tamamını dolduramıyorsanız bilinmeyenleri görünür bırakın. Her satırın karşısına uzun açıklama yazmak yerine ilgili ek numarasını eklemek de mümkündür."],
			"bullets": [
				"Talep kimliği ve sürüm: Bu yazışmayı hangi adla izleyeceğiz, bu gönderim hangi sürüm?",
				"Yer veya varlık: Hangi tesis, bina ya da bölüm konuşuluyor; eklerde aynı kimlik kullanılıyor mu?",
				"İhtiyaç ve beklenen ilk yanıt: İşin kısa tarifi nedir; bilgi listesi, görüşme veya teklif mi bekleniyor?",
				"Mevcut belgeler: Hangi ekler gönderildi; her birinin tarihi, bilinen sürümü ve açıklaması nedir?",
				"Açık sorular: Hangi bilgi bulunamadı; soru hangi birime yöneltildi; yanıt durumu nedir?",
				"Kapsam cevabı: Hangi kalem dahil, hariç, bilgi bekliyor veya ayrı teklif gerektiriyor?",
				"Koordinasyon: Yazışmayı kim derliyor; belirli soruları cevaplayacak görevli birim hangisi?",
				"Değişiklik ve gönderim: Önceki paketten ne değişti; hangi ekler ve sorular için yeni yanıt isteniyor?"
			],
			"note": "Liste tamamlanınca belgeleri hazırlamamış bir çalışma arkadaşınızdan yalnızca dosya düzenini okumasını isteyebilirsiniz. Hangi yerin konuşulduğunu, hangi ekin güncel talebe ait olduğunu ve neye cevap beklendiğini bulabiliyorsa ilk gönderimin anlatımı daha açık hale gelmiş demektir. Bu okuma, belgelerin içeriğine teknik onay verildiği şeklinde kaydedilmemelidir."
		},
		{
			"heading": "Göndermeden önce alıcının göreceği paketi açın",
			"paragraphs": [
				"Son kontrolü kendi çalışma klasörünüzde değil, göndereceğiniz kopyada yapın. Ek listesindeki dosyalar gerçekten var mı, dosyalar açılıyor mu ve açıklamalar doğru eke mi gidiyor? Bir bağlantı kullanıyorsanız alıcının hangi yetkiyle erişeceğini kurumunuzun paylaşım kurallarına göre kontrol edin. Sadece sizin hesabınızda açılan bir bağlantı, karşı tarafa belge ulaştığını kanıtlamaz.",
				"E-posta metnine bütün geçmişi taşımak yerine talebin adını, ek listesini ve beklenen yanıtı koyun. Uzun yazışmadan aktarılan bir kararı kaynak mesajı veya belge kimliğiyle ilişkilendirin. İletişimde tarih beklentisi varsa bunun sizin istediğiniz yanıt tarihi olduğunu belirtin; karşı tarafın teyit etmediği tarihi taahhüt gibi sunmayın. Dosyanın gönderildiği gün ile yanıtın geldiği günü ayrı izleyin.",
				"Kutup Grup ile <a href=\"/iletisim\">hizmet kapsamını görüşmek için iletişime geçerken</a> kısa iş tanımını, ilgili hizmet başlığını ve elinizdeki belgelerin listesini hazırlayın. Büyük veya paylaşımı sınırlı ekler için kullanılacak yöntemi görüşmede belirleyebilirsiniz. İlk mesajın hedefi bütün teknik soruları çözmek değil, doğru soruların doğru belgelerle konuşulacağı bir başlangıç yapmaktır."
			]
		}
	],
	"faqs": [
		{
			"question": "Bütün belgeler hazır olmadan ilk görüşme yapılabilir mi?",
			"answer": "Mevcut belgelerin listesini ve eksik bilgileri açıklayarak ilk görüşme talep edebilirsiniz. Hangi eklerin gerektiğini sorun; eksik dosyayı tamamlanmış gibi sunmayın. Bu ilk görüşme, kesin fiyat veya uygulama başlangıcı taahhüdü değildir."
		},
		{
			"question": "Fotoğrafları tek başına göndermek yeterli mi?",
			"answer": "Fotoğraflara hangi talep ve bölüme ait olduklarını açıklayan bir ek listesi koyun. Bilinen çekim tarihini belirtin, bilinmeyeni tahminle doldurmayın. Bu paket açıklayıcı bir başlangıç sağlar; teknik değerlendirme için yeterli olup olmadığı ayrıca görüşülür."
		},
		{
			"question": "Aynı dosyayı farklı sağlayıcılara nasıl göndermeliyim?",
			"answer": "Ortak talep metninin aynı sürümünü ve paylaşılmasına izin verilen aynı ekleri kullanın. Ortak sorulara gelen açıklamaları güncel tutun. Bir sağlayıcının özel teklifini veya ticari bilgisini diğerlerine aktarmak bu düzenin parçası değildir."
		},
		{
			"question": "Talep numarası ile dosya sürümü aynı şey mi?",
			"answer": "Önerilen düzende talep numarası yazışmanın kimliğini, sürüm ise gönderilen içerikteki değişikliği gösterir. Aynı talebin farklı sürümleri olabilir. Kurumunuz başka bir düzen kullanıyorsa mevcut kimlikleri koruyup değişiklikleri onun içinde izleyin."
		}
	],
	"relatedServices": [
		{
		...
		{
			"label": "Rüzgar Enerji Santralleri",
			"href": "/hizmetler/ruzgar-enerji-santralleri"
		},
		{
			"label": "İç ve Dış Cephe Temizliği",
			"href": "/hizmetler/ic-ve-dis-cephe-temizlik-hizmetleri"
		}
	],
	"relatedPosts": ["endustriyel-dagcilik-iple-erisim-rehberi", "ruzgar-turbini-bakiminda-iple-erisim"],
	"sources": [{
		"label": "NARA — Bulletin 2015-01 Appendix B: dosya adlandırma",
		"url": "https://www.archives.gov/records-mgmt/bulletins/2015/2015-01-appendix-b.html"
	}, {
		"label": "Cambridge Üniversitesi — Dosya düzeni, adlandırma ve sürüm yönetimi",
		"url": "https://www.data.cam.ac.uk/organising-storing/file-organisation-naming-version-control"
	}]
};
//#endregion
//#region src/lib/blog/guvenlik-agi-teslim-kullanim-kontrolu.ts
var guvenlikAgiTeslimPost = {
	...
	"faqs": [
		{
			"question": "Güvenlik ağı ile malzeme tutucu ağ aynı amaçla mı kullanılır?",
			"answer": "Hayır. Personel düşmesini karşılamak ve malzeme düşmesini sınırlamak farklı ihtiyaçlardır. Seçilen sistemin amacı, kapasitesi ve kullanım koşulları teknik belgeler ve saha değerlendirmesiyle doğrulanmalıdır."
		},
		{
	...
	"relatedServices": [
		...
		{
			"label": "Stand-by ve Rescue Hizmeti",
			"href": "/hizmetler/stand-by-rescue-hizmeti"
		},
		{
	...
	"sources": [{
		"label": "HSE — Safety nets and soft landing systems",
		"url": "https://www.hse.gov.uk/construction/safetytopics/safety-nets.htm"
	}, {
...
//#endregion
//#region src/lib/blog/dis-cephe-aydinlatma-bakim-gece-kabulu.ts
var cepheAydinlatmaBakimPost = {
	"slug": "dis-cephe-aydinlatma-bakim-gece-kabulu",
	"title": "Dış Cephe Aydınlatması: Keşif, Bakım ve Gece Kabulü",
	"metaDescription": "Dış cephe aydınlatmasında keşif, erişim, elektrik sorumluluğu, bakım envanteri ve gece kabulünü aynı iş planında nasıl değerlendireceğinizi öğrenin.",
	"excerpt": "Dış cephe aydınlatmasını yalnızca ürün ve görünüm kararı olarak değil, işletme sırasında erişim, kontrol ve teslim kaydı olan bir sistem olarak planlayın.",
	"category": "Dış Cephe Aydınlatma ve Erişim",
	"publishedAt": "2026-09-22",
	"updatedAt": "2026-09-22",
	"image": {
		"src": "/images/blog/dis-cephe-aydinlatma-bakim-gece-kabulu.webp",
		"alt": "Gece aydınlatılmış modern cephede armatürleri ve bakım erişimini gösteren kavramsal yapı illüstrasyonu",
		"title": "Dış cephe aydınlatmasında bakım erişimi ve gece kabulü",
		"caption": "Dış cephe aydınlatması, erişim ve kabul kararlarının birlikte ele alındığı kavramsal sahne; gerçek bir Kutup Grup uygulamasını göstermemektedir.",
		"width": 1774,
		"height": 887
	},
	"keywords": [
		"dış cephe aydınlatması",
		"aydınlatma bakım erişimi",
		"gece kabulü",
		"cephe aydınlatma keşfi"
	],
	"sections": [
		{
			"heading": "Dış cephe aydınlatmasında karar gece görünümüyle bitmez",
			"paragraphs": ["İyi bir dış cephe aydınlatması yalnızca ilk akşam güzel görünen bir kurulum değildir. Aynı armatürün bakım için nasıl erişileceği, elektriksel işin kim tarafından yürütüleceği, ışığın hangi pencerelere ulaşmaması gerektiği ve teslimin hangi koşullarda yapılacağı keşif aşamasında konuşulmalıdır. Bina yöneticisi için doğru başlangıç sorusu “kaç lamba takılacak?” değil, “bu sistem işletme sırasında nasıl yönetilecek?” sorusudur. Böyle kurulan dosya, ürün listesini gerçek bir kullanım planına bağlar.", "Kutup Grup’un <a href=\"/hizmetler/dis-cephe-dekoratif-aydinlatma\">dış cephe dekoratif aydınlatma</a> kapsamı; cephe, erişim, ürün ve bakım koşullarının birlikte değerlendirilmesine dayanır. Bu yazı, bir tasarım veya elektrik uygulama projesinin yerine geçmez. Keşif öncesinde hangi bilgilerin hazırlanacağını, tekliflerin nasıl karşılaştırılacağını ve gece kabulünde hangi kayıtların aranacağını anlatır. Yüzey ve erişim konusu için <a href=\"/blog/yuksek-yapilarda-cephe-temizligi-iple-erisim\">yüksek yapılarda cephe temizliği</a> yazısı da tamamlayıcı bir okuma sunar."]
		},
		{
			"heading": "Beklentiyi tek bir gece fotoğrafına sıkıştırmayın",
			"paragraphs": ["Bina sahibinin elindeki referans fotoğraf, renk veya parlaklık için iyi bir başlangıç olabilir; fakat tek başına uygulanabilir bir kapsam anlatmaz. Fotoğrafın hangi mesafeden çekildiği, hangi saat ve hava koşulunda görüldüğü, çevredeki pencerelerin ne durumda olduğu ve görüntünün gerçek bir uygulama mı yoksa tasarım görseli mi olduğu sorulmalıdır. Cephede istenen etki, giriş yaklaşımı ve komşu kullanım birlikte tarif edilmezse teklif veren taraf aynı görseli farklı varsayımlarla yorumlar.", "Hazırlık notuna üç ayrı beklenti yazın: vurgulanacak yüzey, karanlık kalması istenen alan ve işletmenin kabul etmeyeceği etki. Bir pencereye doğrudan ışık gelmemesi, araç sürücüsünün gözünün kamaşmaması veya logonun yalnızca belirli saatlerde görünmesi tasarım kararını değiştirir. Böylece “daha parlak olsun” gibi ölçüsüz bir talep yerine gözlenebilir bir kullanım senaryosu ortaya çıkar. Tasarım görseli kesin fotometrik sonuç veya belirli enerji tüketimi vaadi olarak sunulmamalıdır."]
		},
		{
			"heading": "Keşif dosyasında gündüz ve gece bilgisi birlikte bulunsun",
			"paragraphs": ["Gündüz çekilmiş cephe fotoğrafları malzeme, derz, kaplama ve erişim izlerini gösterir; gece fotoğrafları ise mevcut ışığın dağılımını ve çevreyle ilişkisini anlamaya yardımcı olur. Her fotoğrafın yönü, tarihi ve çekim noktası yazılırsa farklı günlerdeki görüntüler karşılaştırılabilir. Cephe çizimleri, armatür envanteri, daha önce yapılan onarımlar ve bilinen su alma sorunları da aynı dosyada tutulmalıdır. Eski çizimlerin güncel uygulama gibi okunmasını önlemek için revizyon bilgisi eklenir.", "Bina girişleri, çatı erişimi, elektrik panosu, kontrol noktaları ve çalışma saatleri keşifte ayrı sorular olarak yer alır. Bir cephe gece boş görünse bile gündüz yoğun yaya trafiği veya etkinlik hazırlığı nedeniyle kapatılamayabilir. Yönetim, hangi alanlara erişim izni gerektiğini ve kimin onay vereceğini önceden paylaşmalıdır. Eksik bilgi varsa dosyada “mevcut değil” yazmak, tahmini bir değer eklemekten daha kullanışlıdır; keşif ekibi hangi noktayı yerinde doğrulayacağını bilir."]
		},
		{
			"heading": "Cephe malzemesi sabitleme ve güzergâhı etkiler",
			"paragraphs": ["Taş kaplama, metal panel, cam, sıva ve kompozit yüzey aynı montaj ayrıntısıyla ele alınamaz. Görünen kaplama ile arkasındaki taşıyıcı birbirinden ayrılmalı; derz, hareket payı, su tahliye yolu ve bakım kapağı gibi öğeler işaretlenmelidir. Cepheye daha önce yapılmış müdahaleler veya bilinen çatlaklar saklanmamalıdır. Aydınlatmanın mimari katkısı konuşulurken yapı kabuğunun su, ısı ve bakım işlevi geri plana itilirse ilk kurulumdan sonraki sorunlar büyüyebilir.", "Armatürün yerini seçmek, kablonun nereden geçeceği ve ileride hangi parçaya dokunulacağıyla birlikte düşünülür. Teklifte sabitleme çözümünü, cepheyle ilgili izinleri ve onarım sınırını kimin değerlendireceği belirtilmelidir. Ürünün dış ortama uygun olarak tanımlanması, her cephede aynı montajın uygun olduğu anlamına gelmez. Bu yazı belirli delik yeri veya bağlantı tarifi vermez; ürün talimatı, yapı koşulları ve yetkin tasarım değerlendirmesi birlikte doğrulanır."]
		},
		{
			"heading": "İlk montaj erişimi bakım gününü de belirler",
			"paragraphs": ["Yeni yapıda kurulum sırasında kullanılan iskele, platform veya vinç işletme döneminde bulunmayabilir. Armatür değişimi ve kablo kontrolü için her seferinde farklı bir erişim düzeni kurulacaksa bu durum tasarım kararına geri bildirim olarak dönmelidir. Bakım ekibinin yaklaşacağı alan, çatı ve zemin kullanımı, alt alanın kapatılması ve olası kurtarma düzeni keşifte sorulur. Erişilebilirlik, yalnızca armatürün önüne ulaşmak değil, işi uygun koşullarda yapabilmektir.", "<a href=\"/blog/endustriyel-dagcilik-iple-erisim-rehberi\">Endüstriyel dağcılık ve iple erişim</a> yazısındaki yöntem karşılaştırması bu sorulara yardımcı olabilir. İple erişim, platform veya başka bir yöntem; görev, cephe ve çevre koşullarına göre değerlendirilir. Mevcut <a href=\"/hizmetler/yatay-ve-dusey-yasam-hatti\">yaşam hattı sisteminin</a> bulunması her armatüre uygun erişim sağlandığını göstermez. Kullanım amacı, bağlantı koşulları ve kurtarma yaklaşımı ayrıca incelenir. Teklifte erişim varsayımları yazılırsa ilerideki bakımın hangi koşullara bağlı olduğu görünür."]
		},
		{
			"heading": "Armatür envanteri satın alma listesinden fazlasıdır",
			"paragraphs": ["Ürün adı ve adet teklif için gereklidir; bakım ekibinin arızayı bulması için tek başına yeterli değildir. Armatürün cephedeki konumu, ürün kodu, ilgili kontrol bölgesi, erişim notu ve varsa fotoğrafı aynı kimlikle eşleştirilebilir. Aynı ürün ailesinde farklı ışık dağılımı veya kontrol özelliği bulunabileceği için benzer görünen iki parçanın eşdeğer olduğu varsayılmamalıdır. Değişim gerektiğinde doğru parçayı tanımlamak, gereksiz sökme ve tekrar ziyaret riskini azaltır.", "Sürücü, bağlantı kutusu ve kontrol bileşenleri armatürden farklı bir yerde olabilir. Bu parçaların konumu belgelenmezse dış cepheye çıkmadan yapılabilecek inceleme de yanlış planlanır. Ürün dokümanları, sahadaki konum çizimi ve son değişiklikler tek bir revizyonla ilişkilendirilmelidir. Değişiklik yapıldığında eski kodun üzerine sessizce yazmak yerine tarih, neden ve yeni kod kaydedilir. Böylece yeni yönetici aynı cephede neden farklı parçalar bulunduğunu tahmin etmek zorunda kalmaz."]
		},
		{
			"heading": "Elektrik işi ile erişim işinin sorumluluğunu ayırın",
			"paragraphs": ["Bir armatüre ulaşabilmek, elektriksel müdahaleyi yapmaya yetkin olmakla aynı şey değildir. Keşif ve teklif sırasında erişim, elektriksel değerlendirme, montaj, kontrol, izolasyon ve devreye alma görevleri ayrı ayrı yazılmalıdır. <a href=\"https://www.hse.gov.uk/electricity/withequip.htm\" target=\"_blank\" rel=\"noopener noreferrer\">HSE’nin elektrik ekipmanında çalışma rehberi</a> planlama, enerji kaynaklarının güvenli biçimde izole edilmesi ve işi yapan kişilerin yetkinliği üzerinde durur. Kaynak Birleşik Krallık bağlamındadır; Türkiye’deki tesisin mevzuat veya proje değerlendirmesinin yerine geçmez.", "İşveren açısından amaç bir bağlantı yöntemini tarif etmek değil, sorumluluk boşluğu bırakmamaktır. Elektrik kesintisini kimin onaylayacağı, hangi devrelerin etkileneceği ve yeniden devreye alma kararının kimde olduğu planlanmalıdır. Pano adı, devre bilgisi ve güncel çizim birbiriyle uyuşmuyorsa uygulamadan önce bu fark çözülür. Erişim ekibinin programı ile elektrik işinin programı aynı takvimde gösterilir. Bu yazı enerjili çalışma önermez; elektriksel işlemler tesis prosedürü, yetkinlik ve sahaya özel güvenlik düzeni gerektirir."]
		},
		{
			"heading": "Işığın nereye ulaşmaması gerektiğini de belirleyin",
			"paragraphs": ["<a href=\"https://darksky.org/resources/guides-and-how-tos/lighting-principles/\" target=\"_blank\" rel=\"noopener noreferrer\">DarkSky International’ın dış aydınlatma ilkeleri</a> ışığın amacına hizmet etmesini, hedeflenmesini, gereğinden parlak olmamasını, kontrol edilebilmesini ve uygun yerlerde daha sıcak renklerin düşünülmesini önerir. Cephe için pratik karşılığı; aydınlatılacak yüzey kadar komşu pencereyi, gökyüzünü, yaya yolunu ve çevredeki yaşam alanını da değerlendirmektir. Bu ilkeler belirli bir ürünün veya şirketin sertifikalı olduğunu göstermez. Yerel izin ve proje koşulları ayrıca incelenmelidir.", "Keşif dosyasında rahatsızlık oluşturabilecek bakış noktalarını işaretleyin. Karşı bina penceresi, girişte bekleyen kişi ve sürücünün yaklaşım yönü aynı ışığı farklı algılayabilir. Daha fazla armatür eklemek her zaman daha iyi görünüm sağlamaz; bazı yüzeyleri karanlık bırakmak mimari anlatımın parçası olabilir. Tasarım görüşmesinde bu alanların gece denemesinde nasıl değerlendirileceği yazılırsa teslim “bütün lambalar yanıyor” kontrolüne indirgenmez."]
		},
		{
			"heading": "Numune alanı kararı erkenden görünür kılar",
			"paragraphs": ["Tüm cepheye geçmeden önce temsil edici bir bölümün incelenmesi, renk, gölge, yansıma ve komşu alan etkisini birlikte görmeye yardımcı olabilir. Numune alanı yalnızca kolay erişilen yüzeyden seçilmemeli; gerçek cephe dokusunu ve çevre koşulunu temsil etmelidir. Numune her proje için mümkün olmayabilir; yapılacaksa sınırı ve değerlendirme yöntemi teklif sırasında yazılır. Sayısal performans beklentisi varsa neyin, hangi araçla ve hangi sorumlu tarafından ölçüleceği ayrıca tanımlanır.", "Karar notunda hangi ürünün, hangi kontrol senaryosunda ve hangi bakış noktalarından değerlendirildiği bulunur. Telefonla çekilmiş tek bir fotoğraf yerine gözlem koşullarını anlatan kısa kayıt daha karşılaştırılabilirdir. Görsel etkiyi onaylayan kişiyle elektriksel uygunluğu değerlendiren kişinin görevi aynı olmayabilir. Numunedeki olumlu izlenim başka bir cephe malzemesinde aynı sonucun kesin elde edileceği anlamına gelmez. Sonraki değişiklikler numune kararından sapıyorsa bu fark görünür biçimde kaydedilir."]
		},
		{
			"heading": "Çalışma saatleri ve kontrol senaryoları işletmeye göre kurulmalı",
			"paragraphs": ["Aydınlatmanın ne zaman açılacağı kadar ne zaman kısılacağı veya kapanacağı da konuşulmalıdır. Bina kapanış saati, gece personeli, etkinlikler ve komşu kullanım birlikte değerlendirilir. Tek bir sürekli açık senaryo işletmenin bütün ihtiyacını temsil etmeyebilir. Ayarları kimin değiştirebildiği ve değişikliğin nerede kaydedildiği işletme düzeninde yer almalıdır. Geçici bir müdahalenin aylarca unutulmaması için başlangıç ve geri dönüş koşulu yazılır.", "Kontrol sisteminin elektrik kesintisi sonrasında hangi duruma döneceği, saat ayarının nasıl yönetileceği ve olağan dışı durumda kimin karar vereceği teslimde açıklanır. Ürün dokümanında bulunmayan uzaktan erişim veya otomasyon varmış gibi anlatılmamalıdır. Yönetim arayüzü varsa kullanım bilgileri yetkili kişilere güvenli biçimde aktarılır; herkese açık teknik dosyada erişim bilgisi tutulmaz. İşletme senaryosu çalıştırılıp kayda alınmadan ürün özelliği, tamamlanmış bir sonuç gibi sunulmaz."]
		},
		{
			"heading": "Enerji beklentisini varsayımlarıyla birlikte okuyun",
			"paragraphs": ["LED kullanılması tek başına belirli bir tasarruf oranını garanti etmez. Mevcut sistemin gücü, yeni yerleşimdeki ürün sayısı, kullanım süresi, kontrol senaryosu ve bakım koşulları bilinmeden iki faturayı karşılaştırmak eksik kalır. Yeni tasarım daha geniş bir yüzeyi aydınlatıyorsa eski tüketimle doğrudan kıyaslamak yanıltıcı olabilir. İşveren sonuç vaadi yerine hesapta kullanılan kabulleri, ölçüm yöntemini ve hangi verinin işletmeden beklendiğini istemelidir.", "Bir teklif daha düşük ürün gücü sunarken daha uzun çalışma süresi varsayıyor olabilir. Karşılaştırma kaydında ürünler kadar çalışma senaryoları da yan yana konur. Erişim, değiştirilebilir parçalar ve duruş ihtiyacı toplam işletme kararının diğer parçalarıdır. Bu bilgiler sabit bir geri ödeme süresine dönüştürülmemelidir. Sistem çalışmaya başladıktan sonra hangi verinin, hangi aralıkla ve kimin tarafından izleneceği belirlenirse başlangıç varsayımıyla gerçek kullanım deneyimi karşılaştırılabilir."]
		},
		{
			"heading": "Cephe temizliği ile aydınlatma bakımı aynı takvimde konuşulsun",
			"paragraphs": ["Armatürlerin ve kablo güzergâhlarının bulunduğu yüzeylerde temizlik planlanırken ürün talimatları dikkate alınır. Kullanılacak su, kimyasal, ekipman ve erişim güzergâhının aydınlatma bileşenleriyle ilişkisi değerlendirilmelidir. Temizlik ekibinin rotası montaj elemanlarıyla çakışabilir veya bakım için bırakılan kapağın önü kapatılabilir. Cephe ve aydınlatma kayıtları birbirinden habersiz tutulursa işletme, aynı erişim düzenini iki kez kurmak veya birbirine zarar veren işleri aynı güne sıkıştırmak zorunda kalabilir.", "<a href=\"/hizmetler/ic-ve-dis-cephe-temizlik-hizmetleri\">İç ve dış cephe temizliği</a> kapsamı görüşülürken aydınlatma envanterini paylaşın. Aynı erişim organizasyonunda birden fazla iş düşünülebilir; ancak görevler, yetkinlikler ve kabul koşulları uyumlu değilse yalnızca zaman kazanmak için birleştirilmemelidir. Elektriksel kontrol, temizlik ve mekanik bakımın sırası ürün ve saha gereklilikleriyle belirlenir. <a href=\"/blog\">Blogdaki bakım ve erişim içerikleri</a> bu koordinasyonu planlarken kullanılabilecek genel bir çerçeve sunar."]
		},
		{
			"heading": "Gece kabulü için bakış noktalarını önceden seçin",
			"paragraphs": ["Teslimde bütün armatürlerin çalışması kontrol edilir; görsel kabul bununla bitmez. Giriş yaklaşımı, karşı kaldırım, ilgili iç mekân ve komşu yapı gibi bakış noktaları önceden belirlenebilir. Her noktanın erişim izni ve güvenliği hesaba katılır. İstenen mimari etkiyle rahatsız edici parlaklık aynı görüşmede değerlendirilmelidir. Gündüz görünmeyen bir kablo gölgesi, yansıma veya cephe birleşimi gece algısını değiştirebilir; tespitler konumla ilişkilendirilerek kaydedilir.", "Fotoğrafların hangi senaryoda ve mümkün olduğunca karşılaştırılabilir koşullarda çekildiği belirtilir. Fotoğraf destek kaydıdır; istenen teknik ölçümün yerine geçmez. İşveren görsel olarak kabul edilen bölümlerle düzeltme bekleyenleri ayırmalıdır. Renk veya yön ayarı sonradan değişecekse kimin, hangi kapsamda ve ne zaman müdahale edeceği yazılır. Böylece teslimden sonra yapılan değişiklikler yeni bir memnuniyetsizlik görüşmesine dönüşmek yerine önceki kabul kaydı üzerinden ele alınabilir."]
		},
		{
			"heading": "Arıza bildirimi bakımın ilk verisidir",
			"paragraphs": ["“Cephe ışıkları çalışmıyor” ifadesi arızanın sınırını anlatmaz. İşletme personeli güvenli bulunduğu yerden hangi bölümün etkilendiğini, ne zaman fark edildiğini ve durumun sürekli mi aralıklı mı olduğunu kaydedebilir. Bilinen bir kesinti veya senaryo değişikliği varsa bildirimde belirtilir. Bu bilgi teknik ekibin görevini tanımlamasına yardımcı olur; personelin panoya veya armatüre müdahale etmesini gerektirmez. Hasarlı veya şüpheli elektrik ekipmanı yetkin kişilere bırakılmalıdır.", "Bakım kaydında yalnızca değiştirilen parça değil, işlemin nedeni ve devreye alma sonucu da bulunur. Tekrarlayan bir arızada önceki müdahaleler görülebilirse her ziyaret sıfırdan başlamaz. Cephede yeni su izi veya mekanik hasar fark edilmişse yapı sorumlusuna aktarılır. Sorunun aydınlatma bileşeninden mi başka bir yapı etkisinden mi kaynaklandığı incelemeyle belirlenir. Bir parça değişiminin bütün sistemin durumunu doğruladığı varsayılmamalıdır."]
		},
		{
			"heading": "Aynı ürünle hazırlanan iki teklif neden ayrışır?",
			"paragraphs": ["Varsayımsal bir bina için iki teklifin aynı armatür modelini içerdiğini düşünelim. İlk teklif montajı ve gündüz çalışırlık kontrolünü, ikinci teklif bunlara ek olarak gece senaryo ayarını ve uygulanan yerleşim dosyasını kapsıyor olsun. Ürün adedi ve toplam bedel tek başına bu farkı göstermez. İşveren, kendi kabul beklentisini yazıp her teklifin aynı ihtiyaca yanıt verip vermediğini sormalıdır. Bu örnek gerçek bir müşteri veya proje sonucu değildir; kapsamın ürün listesinden ayrı okunması gerektiğini gösterir.", "Bakım erişimi de benzer fark yaratabilir. Bir teklifte çatı erişiminin işletme tarafından sağlanacağı, diğerinde zemin kullanım izninin henüz alınmadığı varsayılmış olabilir. İzinlerin ne zaman ve kim tarafından tamamlanacağı bilinmiyorsa kurulum takvimi kesinleşmiş sayılmaz. Karşılaştırma sırasında üç liste hazırlayın: teslim edilecek ürünler, yapılacak saha işleri ve işletmeye devredilecek bilgiler. “Anahtar teslim” ifadesi bu üç listenin yerini tutmaz."]
		},
		{
			"heading": "Teslim dosyası sonraki sorumluya da anlaşılır gelmeli",
			"paragraphs": ["Uygulanan yerleşim, ürün kodları, kontrol senaryoları, bakım erişim notları, yapılan kontroller ve açık işler aynı teslim düzeninde bulunmalıdır. Dosyanın yalnızca tasarım görsellerinden oluşması işletmeye yeterli bilgi vermez. Sahadaki son durumun çizimle eşleştiği doğrulanmalı; ürün talimatlarının nerede saklandığı ve bakım talebinin nasıl açılacağı belirtilmelidir. Yönetici değiştiğinde bilgi kişisel mesajlaşma geçmişinde kalmamalıdır.", "Teklif görüşmesine hazırlanırken cephe fotoğraflarını, mevcut çizimleri, çalışma saatlerini ve bakım erişimiyle ilgili kısıtları bir araya getirin. Kutup Grup ile <a href=\"/iletisim\">keşif ve uygulama kapsamını görüşürken</a> görsel beklentiyi işletme bilgileriyle birlikte paylaşın. Hangi değerlendirmelerin yerinde yapılacağı, hangi uzmanlıkların gerektiği ve kabulde hangi kayıtların sunulacağı netleşsin. Binanın gece görünümünü kararlaştırırken ilk bakım gününde erişimin nasıl kurulacağını da aynı dosyada görebilmek işletme için somut bir avantajdır."]
		}
	],
	"faqs": [
		{
			"question": "Dış cephe aydınlatması keşfi için hangi bilgiler hazırlanmalı?",
			"answer": "Gündüz ve gece fotoğrafları, güncel cephe ve elektrik çizimleri, ürün kayıtları, çalışma saatleri, görsel beklenti ve bakım erişimi kısıtları başlangıç dosyasında birlikte bulunmalıdır."
		},
		{
			"question": "İlk montajdaki erişim yöntemi bakım için de uygun mudur?",
			"answer": "Her zaman değil. Montajda bulunan iskele veya platform işletme döneminde bulunmayabilir. Bakım görevi, yaklaşım alanı, çatı ve zemin kullanımı ile kurtarma koşulları ayrıca değerlendirilmelidir."
		},
		{
			"question": "Gece kabulünde yalnızca armatürlerin yanması yeterli mi?",
			"answer": "Hayır. Çalışırlık kontrolüne ek olarak belirlenen bakış noktalarından görsel etki, kontrol senaryoları, komşu alanlara ışık etkisi ve açık düzeltmeler değerlendirilir. Gerekli teknik ölçümler fotoğraflarla ikame edilmez."
		},
		{
			"question": "LED kullanımı belirli bir tasarruf oranını garanti eder mi?",
			"answer": "Hayır. Karşılaştırma mevcut ve yeni sistemin gücü, ürün sayısı, kullanım süresi ve kontrol senaryosu gibi verilerle yapılmalıdır. Sonuç ancak kullanılan varsayımlarla birlikte anlamlıdır."
		}
	],
	"relatedServices": [
		{
	...
	"relatedPosts": ["endustriyel-dagcilik-iple-erisim-rehberi", "yuksek-yapilarda-cephe-temizligi-iple-erisim"],
	"sources": [
		{
			"label": "HSE — Assessing all work at height",
			"url": "https://www.hse.gov.uk/construction/safetytopics/assess.htm"
		...
		{
			"label": "HSE — Work on electrical equipment, machinery or installations",
			"url": "https://www.hse.gov.uk/electricity/withequip.htm"
		},
		{
			"label": "DarkSky International — Five Principles for Responsible Outdoor Lighting",
				...
				children: [/* @__PURE__ */ jsx("nav", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx(Link$1, {
								href: `/iletisim?hizmet=${service.slug}`,
								className: "btn btn-cta",
...
var contact_module_default = {
	contactPage: "_contactPage_4ukz3_1",
	hero: "_hero_4ukz3_7",
	heroContent: "_heroContent_4ukz3_15",
	heroTitle: "_heroTitle_4ukz3_21",
	fadeInUp: "_fadeInUp_4ukz3_1",
	heroSubtitle: "_heroSubtitle_4ukz3_29",
	container: "_container_4ukz3_36",
	contactInfo: "_contactInfo_4ukz3_43",
	infoCard: "_infoCard_4ukz3_50",
	infoIcon: "_infoIcon_4ukz3_66",
	infoTitle: "_infoTitle_4ukz3_71",
	infoText: "_infoText_4ukz3_78",
	contentGrid: "_contentGrid_4ukz3_94",
	sectionTitle: "_sectionTitle_4ukz3_107",
	formSection: "_formSection_4ukz3_115",
	contactForm: "_contactForm_4ukz3_122",
	formGroup: "_formGroup_4ukz3_128",
	formRow: "_formRow_4ukz3_134",
	label: "_label_4ukz3_146",
	required: "_required_4ukz3_152",
	input: "_input_4ukz3_156",
	select: "_select_4ukz3_157",
	textarea: "_textarea_4ukz3_158",
	inputError: "_inputError_4ukz3_183",
	errorText: "_errorText_4ukz3_191",
	fieldHint: "_fieldHint_4ukz3_197",
	checkboxLabel: "_checkboxLabel_4ukz3_208",
	checkbox: "_checkbox_4ukz3_208",
	submitButton: "_submitButton_4ukz3_231",
	successMessage: "_successMessage_4ukz3_253",
	errorMessage: "_errorMessage_4ukz3_262",
	mapSection: "_mapSection_4ukz3_272",
	mapContainer: "_mapContainer_4ukz3_279",
	workingHours: "_workingHours_4ukz3_285",
	hoursTitle: "_hoursTitle_4ukz3_292",
	hoursList: "_hoursList_4ukz3_299",
	whatsappSection: "_whatsappSection_4ukz3_322",
	whatsappCard: "_whatsappCard_4ukz3_326",
	whatsappIcon: "_whatsappIcon_4ukz3_343",
	whatsappContent: "_whatsappContent_4ukz3_347",
	whatsappButton: "_whatsappButton_4ukz3_362"
};
//#endregion
//#region src/pages/Contact.tsx
function ContactPageClient() {
	const [searchParams] = useSearchParams();
	const requestedService = SERVICES_DATA[searchParams.get("hizmet") || ""];
		...
		try {
			...
			if (response.ok && data.success) {
				trackEvent("generate_lead", {
					...
					service_slug: formData.hizmet_slug || void 0
				});
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												requestedService && /* @__PURE__ */ jsxs("p", {
													className: contact_module_default.fieldHint,
													children: ["Seçilen hizmet: ", requestedService.title]
												})
											]
										}),
										/* @__PURE__ */ jsxs("div", {
